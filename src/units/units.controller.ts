...
export class UnitsController {
  ...
  @ApiOperation({
    ...
    description:
      'The unit code is auto-generated per property (U-101, U-102…). Deposit is always 2× rent, computed server-side.',
  })
  ...
  @ApiOperation({ summary: 'List all units in a property', description: 'Sorted by unit code.' })
  ...
  @ApiOperation({
    ...
    description:
      'Status and tenant occupancy are not editable here — they change only through lease actions.',
  })
  @ApiResponse({ status: 200, type: UnitResponseDto })
